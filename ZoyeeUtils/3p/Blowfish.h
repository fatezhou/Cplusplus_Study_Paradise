...
public:
	...
	// Encrypt/Decrypt from/to CString
// 	CString EncryptToString(unsigned char* buf, size_t n, int iMode=ECB);
// 	void DecryptFromString(CString szCypherText, unsigned char* out, size_t n, int iMode=ECB);
// 	CString DecryptToString(unsigned char* buf, size_t len, int iMode=ECB);
// 	CString DecryptFromStringToString(CString szCypherText, int iMode=ECB);

	std::string CBlowFish::EncryptToString(unsigned char* buf, size_t n, int iMode=ECB);
	void CBlowFish::DecryptFromString(std::string szCypherText, unsigned char* out, size_t n, int iMode=ECB);
	std::string CBlowFish::DecryptToString(unsigned char* buf, size_t len, int iMode=ECB);
	std::string CBlowFish::DecryptFromStringToString(std::string szCypherText, int iMode=ECB);
