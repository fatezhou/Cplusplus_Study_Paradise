...
#define _KEY_ ZoyeeUtils::_KEY_CLASS_ m_AutoLockKey;
#define _LOCK_ ZoyeeUtils::_AUTO_LOCK_CLASS_ _auto_lock_(m_AutoLockKey);
#define _AUTO_LOCK_CLASS ZoyeeUtils::_KEY_CLASS_ m_AutoLockKey;
#endif